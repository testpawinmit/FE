...
export class CheckinReportComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  getCheckInReport() {
    ...
    //api call
    this.customerService.getCheckInReport(this.commonCode).then(data => {
      ...
      data.subscribe((response) => {
        ...
        if (response.response === 'Ok') {
          ...
          this.fullCheckInReport = response.checkinList;
