...
export class CheckoutReportComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  getCheckOutReport() {
    ...
    //api call
    this.customerService.getCheckOutReport(this.commonCode).then(data => {
      ...
      data.subscribe((response) => {
        ...
        if (response.response === 'Ok') {
          ...
          this.fullCheckOutReport = response.checkoutList;
